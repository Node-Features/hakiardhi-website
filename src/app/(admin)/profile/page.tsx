              ...
              <div className="flex items-center gap-3">
                {currentUser.role && (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 text-sm font-medium text-white bg-white/20 rounded-full backdrop-blur-sm">
                    ...
                    {typeof currentUser.role === 'object' && 'name' in currentUser.role ? currentUser.role.name : currentUser.role}
                  </span>
                )}
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <Input
                      type="text"
                      value={typeof currentUser.role === 'object' && currentUser.role && 'name' in currentUser.role ? currentUser.role.name : currentUser.role || 'No role assigned'}
                      disabled={true}
