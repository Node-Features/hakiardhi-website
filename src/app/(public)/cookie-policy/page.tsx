...
export const metadata: Metadata = {
  title: "Cookie Policy | LARRRI Admin Portal",
  description: "Learn how LARRRI uses cookies and tracking technologies",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 lg:pt-32 lg:pb-24">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white">Cookie Policy</h1>
          </div>
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">1. What Are Cookies?</h2>
          ...
          {/* Types of Cookies */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">2. Types of Cookies We Use</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.1 Essential Cookies</h3>
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.2 Analytics and Performance Cookies</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.3 Functionality Cookies</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.4 Marketing and Targeting Cookies</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          ...
          {/* Third-Party Cookies */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">3. Third-Party Cookies</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-4">
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Google Analytics</h4>
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                Learn more: <a href="https://policies.google.com/technologies/cookies" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">Google's Cookie Policy</a>
              </p>
            </div>

            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-4">
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Social Media Platforms</h4>
              <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-2">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-4">
              <h4 className="font-bold text-gray-900 dark:text-white mb-2">Payment Processors</h4>
          ...
          {/* Managing Cookies */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">4. How to Manage Cookies</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4.1 Cookie Consent Tool</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4.2 Browser Settings</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-gray-300">
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">Google Chrome</a></li>
              <li><a href="https://support.mozilla.org/en-US/kb/cookies-information-websites-store-on-your-computer" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">Mozilla Firefox</a></li>
              <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">Safari</a></li>
              <li><a href="https://support.microsoft.com/en-us/microsoft-edge/delete-cookies-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">Microsoft Edge</a></li>
            </ul>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4.3 Important Notes</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          ...
          {/* Do Not Track */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">5. Do Not Track Signals</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">6. Other Tracking Technologies</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6.1 Web Beacons and Pixels</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6.2 Local Storage</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Updates */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">7. Changes to This Cookie Policy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          {/* More Information */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">8. More Information</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              For more information about how we collect, use, and protect your personal data, please read our <Link href="/privacy-policy" className="text-brand-500 hover:underline dark:text-brand-400">Privacy Policy</Link>.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              To learn more about cookies in general, visit <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-brand-500 hover:underline dark:text-brand-400">www.allaboutcookies.org</a>.
            </p>
          </section>

          {/* Contact */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">9. Contact Us</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
