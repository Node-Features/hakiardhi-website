...
export const metadata: Metadata = {
  title: "Terms of Service | LARRRI Admin Portal",
  description: "Terms and conditions for using LARRRI services",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 lg:pt-32 lg:pb-24">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-black text-gray-900 dark:text-white">Terms of Service</h1>
          </div>
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert">
          ...
          {/* Use of Services */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">2. Use of Services</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.1 Permitted Use</h3>
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">2.2 Prohibited Activities</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
              You agree not to:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-gray-300">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">3. Intellectual Property Rights</h2>
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3.2 Limited License</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3.3 Restrictions</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* User Content */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">4. User-Generated Content</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4.1 Your Submissions</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4.2 Your Responsibility</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
          ...
          {/* Legal Aid Services */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">5. Legal Aid and Professional Services</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5.1 Not Legal Advice</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5.2 No Attorney-Client Relationship</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5.3 Service Availability</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Disclaimers */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">6. Disclaimers</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6.1 "As Is" Basis</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6.2 Accuracy of Information</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">6.3 Third-Party Links</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">7. Limitation of Liability</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Indemnification */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">8. Indemnification</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          {/* Donations */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">9. Donations and Payments</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">9.1 Voluntary Contributions</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">9.2 Tax Receipts</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">9.3 Payment Processing</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Privacy */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">10. Privacy</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Your use of our services is also governed by our <Link href="/privacy-policy" className="text-brand-500 hover:underline dark:text-brand-400">Privacy Policy</Link>, which explains how we collect, use, and protect your personal information. Please review our Privacy Policy to understand our practices.
            </p>
          </section>

          {/* Termination */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">11. Termination</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Governing Law */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">12. Governing Law and Dispute Resolution</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">12.1 Applicable Law</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">12.2 Dispute Resolution</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* General Provisions */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">13. General Provisions</h2>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">13.1 Severability</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              If any provision of these terms is found to be invalid or unenforceable, the remaining provisions shall continue in full force and effect.
            </p>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">13.2 Entire Agreement</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">13.3 Waiver</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              Our failure to enforce any right or provision in these terms shall not constitute a waiver of such right or provision.
            </p>

            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">13.4 Assignment</h3>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          ...
          {/* Contact */}
          <section className="mb-10">
            <h2 className="text-2xl font-black text-gray-900 dark:text-white mb-4">14. Contact Us</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
