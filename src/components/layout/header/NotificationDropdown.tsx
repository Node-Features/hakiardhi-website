  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="right-0 mt-[17px] flex h-[420px] w-[calc(100vw-2rem)] max-w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:h-[480px] sm:w-[361px] lg:right-0"
      >
