...
import UserAvatar from "@/components/layout/common/UserAvatar";
...
export default function UserDropdown() {
  ...
  if (loading) {
    return (
      <div className="w-32 h-11 bg-gray-200 dark:bg-gray-800 rounded-full animate-pulse" />
    );
  }
  return (
      ...
      >
        <div className="flex items-center gap-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className="block mt-0.5 text-theme-xs text-gray-500 truncate dark:text-gray-400">
              {email}
            </span>
            {user?.role && (
